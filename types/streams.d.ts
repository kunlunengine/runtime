// Adapted from web-streams-polyfill 4.2.0 (MIT); see STREAMS-LICENSE.
/**
 ...
 * @public
 */
declare class ReadableStream<R = any> implements AsyncIterable<R> {
 ...
 * @public
 */
declare interface ReadableStreamAsyncIterator<R> extends AsyncIterableIterator<R> {
 ...
 * @public
 */
declare interface ReadableStreamDefaultReaderLike<R = any> {
 ...
 * @public
 */
declare interface ReadableStreamLike<R = any> {
 ...
 * @public
 */
declare type ReadableStreamReader<R> = ReadableStreamDefaultReader<R> | ReadableStreamBYOBReader;
 ...
 * @public
 */
declare interface ReadableWritablePair<R, W> {
...
/** @public */
declare type TransformerCancelCallback = (reason: any) => void | PromiseLike<void>;
